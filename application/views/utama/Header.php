...
<head>
    ...
    <link rel="icon" href="<?= base_url('ptgumacc'); ?>/azzara/assets/img/icon.ico" type="image/x-icon" />
                                ...
                                <li>
                                    <div class="message-notif-scroll scrollbar-outer">
                                        <div class="notif-center">
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img src="<?= base_url('ptgumacc'); ?>/azzara/assets/img/jm_denis.jpg" alt="Img Profile">
                                                </div>
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img src="<?= base_url('ptgumacc'); ?>/azzara/assets/img/chadengle.jpg" alt="Img Profile">
                                                </div>
                                                <div class="notif-content">
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img src="<?= base_url('ptgumacc'); ?>/azzara/assets/img/mlane.jpg" alt="Img Profile">
                                                </div>
                                                <div class="notif-content">
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img src="<?= base_url('ptgumacc'); ?>/azzara/assets/img/talha.jpg" alt="Img Profile">
                                                </div>
                                                <div class="notif-content">
                                ...
                                <li>
                                    <div class="notif-scroll scrollbar-outer">
                                        <div class="notif-center">
                                            ...
                                            <a href="#">
                                                <div class="notif-img">
                                                    <img src="<?= base_url('ptgumacc'); ?>/azzara/assets/img/profile2.jpg" alt="Img Profile">
                                                </div>
                                                <div class="notif-content">
                                                    <span class="block">
